...
/*Free the persistent caches*/
void persistent_cache_free()
{
	free(reading_cache.table);
	free(connection_cache.table);
	free(breakin_cache.table);
	free(owl_cache.table);
	free(semeai_cache.table);
}
