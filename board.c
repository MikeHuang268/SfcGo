...
//SfcGo functions
int do_capture(int pos,int color, int captures[BOARDMAX])
{
	int i;
	int other = OTHER_COLOR(color);
	int n=0;
	if (board[SOUTH(pos)] == other && LIBERTIES(SOUTH(pos)) == 1)
	{
		...
		{
			if(string_number[i]==string_number[SOUTH(pos)])
			{
				captures[n]=i;
				n++;
			}
	...
	if (board[WEST(pos)] == other && LIBERTIES(WEST(pos)) == 1)
	{
		for(i=BOARDMIN;i<BOARDMAX;i++)
		{
			if(string_number[i]==string_number[WEST(pos)])
			{
				captures[n]=i;
				n++;
			}
	...
	if (board[NORTH(pos)] == other && LIBERTIES(NORTH(pos)) == 1)
	{
		for(i=BOARDMIN;i<BOARDMAX;i++)
		{
			if(string_number[i]==string_number[NORTH(pos)])
			{
				captures[n]=i;
				n++;
			}
	...
	if (board[EAST(pos)] == other && LIBERTIES(EAST(pos)) == 1)
	{
		for(i=BOARDMIN;i<BOARDMAX;i++)
		{
			if(string_number[i]==string_number[EAST(pos)])
			{
				captures[n]=i;
				n++;
			}
